...
import proyectog2.service.FirebaseStorageService;
import java.io.File;
...
public class FirebaseStorageServiceImpl implements FirebaseStorageService {
    ...
    public String cargaImagen (MultipartFile archivoLocalCliente, String carpeta, Long id) {
        try {
            ...
            // Se copia a Firestone y se obtiene el url válido de la imagen (por 10 años)
    ...
    // de usuario a un archivo temporal en el servidor.
    ...
    // Método utilitario para obtener para obtener un String con ceros...
