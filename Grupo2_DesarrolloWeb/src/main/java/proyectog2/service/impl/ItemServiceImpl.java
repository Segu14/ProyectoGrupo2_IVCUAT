...
import proyectog2.dao.FacturaDao;
import proyectog2.dao.VentaDao;
import proyectog2.domain.Producto;
import proyectog2.domain.Usuario;
import proyectog2.domain.Factura;
import proyectog2.domain.Item;
import proyectog2.domain.Venta;
import proyectog2.service.UsuarioService;
import proyectog2.service.ItemService;
...
public class ItemServiceImpl implements ItemService {
    ...
    public void facturar() {
        ...
        double total = 0;
        for (Item i : listaItems) {
            System.out.println("Producto: " + i.getNombreProducto()
